...
export const TestsPage: React.FC<TestsPageProps> = ({ onPageChange }) => {
  ...
  const getQuestionCount = (test: any) => {
    return test.type === 'static' 
      ...
      : test.rules.reduce((sum: number, rule: any) => sum + rule.questionCount, 0);
  };
                  ...
                  {([
                    ...
                    <label key={option.value} className="flex items-center space-x-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => setTimeLimitRange(e.target.value as any)}
                  ...
                  {([
                    ...
                    <label key={option.value} className="flex items-center space-x-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => setPassingScoreRange(e.target.value as any)}
                        className="text-blue-600 focus:ring-blue-500"
                      />
                      <span className="text-sm text-gray-700">{option.label}</span>
                    </label>
