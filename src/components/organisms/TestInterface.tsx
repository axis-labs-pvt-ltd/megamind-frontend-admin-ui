...
import { ChevronLeft, ChevronRight, Flag, CheckCircle, RotateCcw } from 'lucide-react';
                  ...
                  <div className="space-y-2">
                    {Array.from({ length: Math.max(currentQuestion.options.length, draggedItems.length + 1) }).map((_, index) => (
                      <div
                        ...
                        className={`min-h-[3.5rem] p-3 border-2 border-dashed rounded-lg transition-all duration-200 ${
                          draggedItems[index]
