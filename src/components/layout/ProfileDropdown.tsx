...
export function ProfileDropdown() {
  ...
  return (
    <div className="relative">
      <ProfileTrigger isOpen={isOpen} onClick={() => setIsOpen(!isOpen)} />
...
function ProfileTrigger({ isOpen, onClick }: { isOpen: boolean; onClick: () => void }) {
  return (
    <button 
      onClick={onClick}
...
function MainMenu({ themeLabel, onNavigateToThemes }: { themeLabel: string; onNavigateToThemes: () => void }) {
  return (
